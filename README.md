...
- LLM-enabled workflow design
- prototype and MVP development
- GitHub-based collaboration and delivery

Across my bootcamp and project work, I have built solutions that connect **business problem framing, technical implementation, data workflows, and presentation-ready delivery**.
...
#### What it does
- converts natural-language project briefs into structured project plans
- validates outputs with schema-based logic
- models dependencies as a DAG
- calculates critical paths
- runs Monte Carlo simulation for delivery forecasting
- provides **P50**, **P80**, delay probability, and risk-driver insights
- supports scenario comparison through a stakeholder-facing Streamlit interface
...
Machine learning project focused on customer transaction prediction using structured data, feature analysis, model evaluation, and business-oriented interpretation.

### Exploratory Data Analysis Project
Data exploration project centered on cleaning, visualization, pattern detection, and extracting decision-relevant insights from structured datasets.

### Artificial Neural Networks Project
Deep learning project exploring ANN-based regression and classification workflows with TensorFlow/Keras.

### Multi-Agent Problem Solver
Project exploring agent-style problem decomposition, AI-assisted reasoning workflows, and lightweight orchestration patterns.

---

## What I Built Across the Bootcamp

- business problem framing and AI feature ideation
- exploratory data analysis and dataset audits
...
**Languages & Tools**  
Python, SQL, Markdown, Git, GitHub
...
GitHub Actions, Docker, environment configuration, documentation, repo structuring, demo-readiness practices
